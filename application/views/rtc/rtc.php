...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url('resources/user/simplertc/');?>stylesheets/stylesheet.css" media="screen">
    <link rel="stylesheet" type="text/css" href="<?=base_url('resources/user/simplertc/');?>stylesheets/github-dark.css" media="screen">
    <link rel="stylesheet" type="text/css" href="<?=base_url('resources/user/simplertc/');?>stylesheets/print.css" media="print">
    <!--[if lt IE 9]>
