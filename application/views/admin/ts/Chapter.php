																...
																<div class="col-md-12">
															        ...
															        <div class="col-md-6">
															          <div class="form-group">
															            <label for="aChapterName" >Chapter Name</label>
															            <input name="aChapterName" id="aChapterName" type="text" class="form-control" placeholder="Chapter Name">
															          </div>
															        </div>

															        <div class="col-md-6">
															          <div class="form-group">
															            <label for="aCourseID" >Course Name</label>
															            <select name="aCourseID" id="aCourseID" class="form-control">
															            	<?php
															            		foreach($cData as $cd)
															            		{
															            			?>
																		            	<option value="<?=$cd->CourseID?>"><?=$cd->CourseName?></option>
															            			<?php
															            		}
															            	?>
															            </select>
