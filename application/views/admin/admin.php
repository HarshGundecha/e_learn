													...
													<form method="POST" id="formAdd<?=$Entity?>">
														...
														<div class="col-md-6">
															<div class="form-group is-empty">
																...
																<input type="text" name="<?=$pf?>AdminName" id="<?=$pf?>AdminName" class="form-control" placeholder="e.g., John">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group is-empty">
																<label for="<?=$pf?>AdminContactNo">Contact No</label>
																<input type="number" name="<?=$pf?>AdminContactNo" id="<?=$pf?>AdminContactNo" class="form-control" placeholder="e.g., 9875xxxxxx">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group is-empty">
																<label for="<?=$pf?>AdminEmail">Email</label>
																<input type="email" name="<?=$pf?>AdminEmail" id="<?=$pf?>AdminEmail" class="form-control" placeholder="e.g., Johndoe@artist.com">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group is-empty">
																<label for="<?=$pf?>AdminPassword">Password</label>
																<input type="password" name="<?=$pf?>AdminPassword" id="<?=$pf?>AdminPassword" class="form-control" placeholder="e.g., xxxxxxxx">
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group is-empty is-fileinput">
																...
																<input type="file" name="<?=$pf?>AdminImage" id="<?=$pf?>AdminImage">
